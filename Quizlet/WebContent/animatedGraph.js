/**
 * This code was adopted from a tutorial hosted on Smashing Magazine. 
 * Original author was Dereck Mack who uploaded the tutorial on 
 * September 23, 2011
 */
$(document).ready(function() {

	// Create our graph from the data table and specify a container to put the graph in
	createGraph('#data-table', '.barGraph');
